  ...
  return (
    <>
      <div style={{ marginLeft: isSidebar ? '' : '-400px' }} className="mobile-menu">
        <span onClick={() => handleSidebar()} aria-label="Mobile menu" className="bars siteBar-btn"><svg className="bi bi-x" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
